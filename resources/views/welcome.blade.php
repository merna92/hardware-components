<x-layout.layout title="Home">
    ...
    <!-- Custom CSS Animations & Sleek Pointer Styling -->
    <style>
        @keyframes float3D {
        ...
        .copy-btn-pointer:hover {
            transform: scale(1.05);
        }
    </style>

    <!-- Scroll-Triggered Welcome Gift Modal -->
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 440px;">
            <div class="modal-content border-0 shadow-lg rounded-5 overflow-hidden position-relative" 
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    <!-- Energetic Friendly Greeting -->
                    <h3 class="fw-black text-dark mb-1 tracking-tight" style="font-weight: 800;">
                        Woohoo! Welcome {{ auth()->user()->first_name ?? 'Neama' }}! 🎉
                    </h3>
                    <p class="text-secondary small mb-3">
                        We are super excited to have you with us! Here is your exclusive VIP welcome offer:
                    </p>

                    <!-- HUGE 30% OFF DISCOUNT BANNER -->
                    ...
                    <div class="p-3 rounded-4 bg-dark text-white position-relative shadow-sm" style="background: #0f172a !important;">
                        <span class="text-white-50 small d-block mb-1 text-uppercase tracking-wider" style="font-size: 0.75rem;">Your Personal Promo Code</span>
    ...
    <!-- JS Confetti Library & Interaction Scripts -->
